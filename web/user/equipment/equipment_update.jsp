                    						...
                    						<div class="col-sm-7">
                    							<div class="form-group">
                    								...
                    								<div class="col-sm-9 form-inline"  >
                                                                        <input id="id" name="id" size="35" class="form-control"  readonly="readonly" type="text" value="${equipment.id}"  tip="请输入设备id" />
                    								</div>
                    							</div>
                    						</div>
                    					</div>
                    <div class="row rowmargin">
                        <div class="col-sm-7">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 form-inline"  >
                                    <input id="uname" name="uname" size="35" class="form-control"   type="text" value="${equipment.uname}"  tip="请输入设备名称" />
                                </div>
                            </div>
                        </div>
                    </div>
